 ...
 * 
 * (참고)
 * Spring 에서 HttpMessageConverter가 동작하기 위해서는
 * Jackson-data-bind 라이브러리가 필요한데
 * Spring boot 모듈에 내장되어 있음
 * (Jackson : 자바에서 JSON 을 다르는 방법 제공하는 라이브러리)
 * 
 * 
*/
@Slf4j
...
public class AjaxController {
	...
	@ResponseBody // 반환 값을 HTTP 응답 본문으로 직접 전송 (값 그대로 돌려보냄)
	...
	public int getCompleteCount() {
		...
		int completeCount = service.getCompleteCount2();
